...
type IsObjectReady func(*unstructured.Unstructured) (isReady bool, retriableError bool, e error)

func alwaysReady(_ *unstructured.Unstructured) (isReady bool, retriableError bool, e error) {
...
func (rc *ReadyChecker) IsReady(obj *unstructured.Unstructured) (isReady bool, retriableError bool, e error) {
...
func (rc *ReadyChecker) checkForInstance(gk schema.GroupKind, obj *unstructured.Unstructured) (isReady bool, retriableError bool, e error) {
	// TODO Check if it is a TPR with Kind/GroupVersion annotation
	return false, false, nil
}

func (rc *ReadyChecker) checkPathValue(gk schema.GroupKind, obj *unstructured.Unstructured) (isReady bool, retriableError bool, e error) {
